...
- Implement *infite scrolling* for data on the home page and the profile feed page using `useInfiniteQuery`. This will allow users to scroll through posts infinitely without needing to click a "Load More" button and is a hallmark feature for most social media apps.
