...
<div className="my-6 w-full overflow-y-auto">
    <table className="w-full">
        ...
        <tr className="m-0 border-t p-0">
            <td className="border px-4 py-2 text-left [&[align=center]]:text-center [&[align=right]]:text-right">
                Your website is deployed using Vercel and is accessible at a URL with the format: `https://a00-personal-porfolio-yourname.vercel.app`.
            </td>
            <td className="border px-4 py-2 text-left [&[align=center]]:text-center [&[align=right]]:text-right">
                20
            </td>
...
2. Your website is deployed to Vercel and is accessible at the URL following the format: `https://a00-personal-porfolio-yourname.vercel.app`.
