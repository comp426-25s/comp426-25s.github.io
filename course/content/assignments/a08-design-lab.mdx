...
![Design Lab](/images/a08/designlab.png)
...
1. Accept the **GitHub Classroom** assignment [here](https://classroom.github.com/a/EiKpD21P).
...
1. Using the same method that you did for a01-a06, create a *deployment fork* of your classroom respository on your personal account. **Make sure this remains a private repository!**
...
7. Override the install command to be: `npm install --force`.
...
2. Your website is deployed to Vercel and is accessible at the URL following the format: `https://a08-design-lab-yourname.vercel.app`.
